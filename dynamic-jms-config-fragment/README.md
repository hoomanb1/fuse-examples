...
on each project sub-folder and then install it into JBoss Fuse: 
      ...
      JBossFuse:karaf@root> install mvn:fuse-examples/jms-connection-fragment/1.0-SNAPSHOT
      JBossFuse:karaf@root> install -s mvn:fuse-examples/camel-broker-client/1.0-SNAPSHOT
